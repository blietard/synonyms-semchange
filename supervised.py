...
class SynonymyClassif:
    ...
    def __init__(self, clf_model, features, kwargs_dict={},CVgridSearch = False, CVgridSearch_score = None, standardscale=False):
    ...
    def reinit(self, new_features = None):
        if new_features:
            self.__init__(self.model_constructor, new_features, self.kwargs, self.CVgrid, self.CVgrid_score, self.standardscale)
        else:
            self.__init__(self.model_constructor, self.features, self.kwargs, self.CVgrid, self.CVgrid_score, self.standardscale)
...
for synsSet in resultsSummary_per_synSets.keys():
    print('=========== ' + synsSet + ' ===========')
    print('-------- Coeffs LR -----------')
    display(lr_features_coeff_per_synSets[synsSet])
    print('-------- Performances -----------')
